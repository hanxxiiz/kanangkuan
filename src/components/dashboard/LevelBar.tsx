...
const LevelBar = () => {
  ...
  return (
    <div className="relative w-90 h-full flex-shrink-0">
      ...
      {/* 2. Progress Bar */}
      <div
        className="absolute top-1/2 -translate-y-1/2 left-12 right-2 h-8 rounded-full z-10 overflow-hidden relative bg-gradient-to-r from-blue to-purple"
        style={{
      ...
      <span className="absolute top-1/2 -translate-y-1/2 left-20 text-white font-main text-md whitespace-nowrap z-20">
        Level {currentLevel}
      </span>
