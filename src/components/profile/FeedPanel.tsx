            ...
            {/* Decks */}
                    <div className="my-3.5">
                        <div className="flex items-center justify-between">   
                            <h1 className="font-bold text-3xl text-gray-900 py-3.5">DECKS</h1>
                            <button className="items-self-end text-md text-gray-900 hover:underline cursor-pointer"
                                    onClick={switchToDecks}>
                                        View all</button>
                        </div>
                        <div className="flex justify-between gap-18 mb-20">
                            <div className="flex flex-col bg-gray-300 text-white w-1/3 h-40 p-5 justify-end space-y-1">
